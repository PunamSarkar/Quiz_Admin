...
public class CategoriesActivity extends AppCompatActivity {
                                            ...
                                            myRef.child("SETS").child(list.get(position).getName()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()){
                                                        ...
                                                        Toast.makeText(CategoriesActivity.this, "Failed to Delete", Toast.LENGTH_SHORT).show();
                                                    }
    ...
    private void setCategoryDialog(){
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(image == null){
                    Toast.makeText(CategoriesActivity.this, "Please select you'r image", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void uploadData(){
        ...
        final StorageReference imageReference = storageReference.child("Image"+(list.size()+1));
